"""ApplyAgent HTML Dashboard Generator.
...
from applyagent.config import APP_DIR, DB_PATH
...
def generate_dashboard(output_path: str | None = None) -> str:
    ...
    Args:
        output_path: Where to write the HTML file. Defaults to ~/.applyagent/dashboard.html.
...
<title>ApplyAgent Dashboard</title>
<style>
